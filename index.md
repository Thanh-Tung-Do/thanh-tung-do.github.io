...
### Age Classification using Facial Features

A project inspired by my part-time job at Dan Murphy’s, where I checked IDs for customers appearing under 25 (ID25). We trained a model to crop facial images and predict the age class of the cropped images. This two-step process isolates the facial region for better analysis before applying age prediction algorithms to estimate the individual’s age group.
