...
In this project, I developed a predictive model to address the challenge of booking cancellations in the hotel industry due to shifts in customer behavior in online reservation channels. By anticipating cancellations through a binary classification model, hotels can optimize their revenue management, adjust pricing strategies, and better allocate resources, ultimately enhancing operational efficiency and guest experiences.

<img src="images/hotel_evaluation.jpg?raw=true" />
